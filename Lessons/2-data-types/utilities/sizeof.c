...
int main() {
  ...
  int x = 10;
  printf("x has size of %zu bytes\n", sizeof(x));

  unsigned int y = 150u;
  printf("y has size of %zu bytes\n", sizeof(y));

  unsigned long long z = 150000LL;
  printf("z has size of %zu bytes\n", sizeof(z));

  bool b = 1;
  printf("b has size of %zu bytes\n", sizeof(b));

  char c = 'A';
  printf("c has size of %zu bytes\n", sizeof(c));

  double d = 10.50;
  printf("d has size of %zu bytes\n", sizeof(d));

  int vett[20];
  printf("vett (array) has size of %zu bytes\n", sizeof(vett));
  printf("vett[0] (element) has size of %zu bytes\n", sizeof(vett[0]));

  struct test t;
  printf("struct test has size of %zu bytes\n", sizeof(t));
